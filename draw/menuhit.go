...
func menucolors(display *Display) {
	...
	menu.high, _ = display.AllocImage(Rect(0, 0, 1, 1), display.ScreenImage.Pix, true, 0x676B6BFF)
	menu.bord, _ = display.AllocImage(Rect(0, 0, 1, 1), display.ScreenImage.Pix, true, 0x676B6BFF)
